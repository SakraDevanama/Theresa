...
| Slay the Spire 2 游戏源码 | `C:\Users\admin\Desktop\Slay the Spire 2beta` |
| BaseLib 源码 | `C:\Users\admin\Documents\GitHub\BaseLib-StS2` |
| BaseLib 快速使用指南 | `D:\Github\SlayTheSpire2ModdingTutorials\BaseLib` |
| 当前 mod 工作目录 | `C:\Users\admin\Desktop\Theresa\Theresa_BaseLibbeta` |
